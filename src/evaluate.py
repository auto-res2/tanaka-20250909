...
"""
src/evaluate.py – lightweight metric & analysis helpers (patched)
"""
...
def save_json(obj: Dict[str, Any], fname: str):
    """Persist *obj* as JSON inside .research/iteration8/ and echo to stdout."""
    path = Path(".research/iteration8")
